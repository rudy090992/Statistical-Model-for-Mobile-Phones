...
ggplot(data = mobile_dataset, mapping = aes(x=Price)) +
        ...
        geom_vline(aes(xintercept = 5000), color="blue", linetype="dashed", size=0.4) +
        geom_vline(aes(xintercept = 22000), color="blue", linetype="dashed", size=0.4) +
          geom_vline(aes(xintercept = 100000), color="blue", linetype="dashed", size=0.4) +
# Add annotation to the plot
        annotate("text", x = 0, y = 200, label = "Cheap", size = 5, color = "blue") +
        annotate("text", x = 10000, y = 200, label = "Affordable", size = 5, color = "blue") +
        annotate("text", x = 50000, y = 200, label = "Expensive", size = 5, color = "blue") +
        annotate("text", x = 125000, y = 200, label = "Luxury", size = 5, color = "blue")
```
